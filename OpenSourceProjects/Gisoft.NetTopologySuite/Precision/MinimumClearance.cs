...
using Gisoft.NetTopologySuite.Index.Strtree;
using Gisoft.NetTopologySuite.Operation.Distance;

namespace Gisoft.NetTopologySuite.Precision
{
    /// <summary>
    ...
    /// the <see cref="STRtree{TItem}.NearestNeighbour(IItemDistance{Gisoft.GeoAPI.Geometries.Envelope,TItem})"/>
