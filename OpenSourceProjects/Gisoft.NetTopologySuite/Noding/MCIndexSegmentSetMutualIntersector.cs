...
using Gisoft.NetTopologySuite.Index.Chain;
using Gisoft.NetTopologySuite.Index.Strtree;
using MonotoneChain = Gisoft.NetTopologySuite.Index.Chain.MonotoneChain;

namespace Gisoft.NetTopologySuite.Noding
{
    ///<summary>
