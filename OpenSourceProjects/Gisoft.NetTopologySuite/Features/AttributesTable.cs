...
namespace Gisoft.NetTopologySuite.Features
{
    /// <summary>
    ...
    public class AttributesTable : IAttributesTable, IEnumerable
    {
        ...
        */
        ...
        /// <summary>
        /// Modify a field with the given value
        /// </summary>
        /// <param name="attributeName">Name of the exists attribute</param>
        /// <param name="value">Value for attribute</param>
        /// <exception cref="ArgumentException">If attribute not exists</exception>
