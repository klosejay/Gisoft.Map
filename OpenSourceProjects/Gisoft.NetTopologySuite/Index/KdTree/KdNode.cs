...
namespace Gisoft.NetTopologySuite.Index.KdTree
{
    /// <summary>
    /// A node of a <see cref="Gisoft.NetTopologySuite.Index.KdTree.KdTree{T}"/>, which represents one or more points in the same location.
    /// </summary>
