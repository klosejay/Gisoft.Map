...
namespace Gisoft.NetTopologySuite.Mathematics
{
    /// <summary>
    ...
    public class Vector2D : ICloneable
    {
        ...
        /// <returns>true if <paramref name="o"/> is a <see cref="T:Gisoft.NetTopologySuite.Mathematics.Vector2D"/>with the same values for the X and Y components.</returns>
