...
namespace Gisoft.NetTopologySuite.Triangulate
{
    ...
    public class IncrementalDelaunayTriangulator
    {
        ...
        public Gisoft.NetTopologySuite.Triangulate.QuadEdge.QuadEdge InsertSite(Vertex v)
        {
            /*
            ...
            Gisoft.NetTopologySuite.Triangulate.QuadEdge.QuadEdge.Splice(baseQuadEdge, e);
            ...
            do {
                ...
                if (t.Dest.RightOf(e) && v.IsInCircle(e.Orig, t.Dest, e.Dest)) {
                    Gisoft.NetTopologySuite.Triangulate.QuadEdge.QuadEdge.Swap(e);
                    e = e.OPrev;
