...
using Gisoft.GeoAPI.Operation.Buffer;
using Gisoft.NetTopologySuite.Algorithm;
using Gisoft.NetTopologySuite.Geometries.Utilities;
using Gisoft.NetTopologySuite.IO;
using Gisoft.NetTopologySuite.IO.GML2;
using Gisoft.NetTopologySuite.Operation;
using Gisoft.NetTopologySuite.Operation.Buffer;
using Gisoft.NetTopologySuite.Operation.Distance;
using Gisoft.NetTopologySuite.Operation.Linemerge;
using Gisoft.NetTopologySuite.Operation.Overlay;
using Gisoft.NetTopologySuite.Operation.Overlay.Snap;
using Gisoft.NetTopologySuite.Operation.Predicate;
using Gisoft.NetTopologySuite.Operation.Relate;
using Gisoft.NetTopologySuite.Operation.Union;
using Gisoft.NetTopologySuite.Operation.Valid;

namespace Gisoft.NetTopologySuite.Geometries
{
    /// <summary>  
    ...
    public abstract class Geometry : IGeometry
    {
        ...
        public int SRID
        {
            ...
            set
            {
                ...
                _factory = Gisoft.GeoAPI.GeometryServiceProvider.Instance.CreateGeometryFactory(
        ...
        /// </returns>
        /// <seealso cref="IGeometryFactory.ToGeometry(Gisoft.GeoAPI.Geometries.Envelope)"/>
        ...
        /// <summary>
        /// Gets an <see cref="Gisoft.GeoAPI.Geometries.Envelope"/> containing 
        ...
        /// and/or update any derived information it has cached (such as its <see cref="Gisoft.GeoAPI.Geometries.Envelope"/> ).
   ...
   * (or equivalently neither covers the other),
    ...
    public static class GeometryEx
    {
        ...
        public static byte[] AsBinary(this IGeometry self, Gisoft.GeoAPI.IO.IBinaryGeometryWriter writer)
        {
            return writer == null
                ? self.AsBinary()
                : writer.Write(self);
