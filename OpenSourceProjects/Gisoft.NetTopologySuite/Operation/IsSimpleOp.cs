...
using Gisoft.NetTopologySuite.GeometriesGraph.Index;

namespace Gisoft.NetTopologySuite.Operation
{
    ///<summary>
    ...
    /// use <see cref="Gisoft.NetTopologySuite.Geometries.Geometry.IsValid()" />).</item>
