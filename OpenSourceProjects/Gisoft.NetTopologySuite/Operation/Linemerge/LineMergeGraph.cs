...
namespace Gisoft.NetTopologySuite.Operation.Linemerge
{
    /// <summary>
    /// A planar graph of edges that is analyzed to sew the edges together. The 
    /// <c>marked</c> flag on <see cref="T:Gisoft.NetTopologySuite.Planargraph.Edge"/>s 
    /// and <see cref="T:Gisoft.NetTopologySuite.Planargraph.Node"/>s indicates whether they have been
