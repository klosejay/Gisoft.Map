...
using Gisoft.NetTopologySuite.Mathematics;
using Gisoft.NetTopologySuite.Noding;
using Gisoft.NetTopologySuite.Noding.Snapround;
...
namespace Gisoft.NetTopologySuite.Operation.Buffer
{
    ...
    public class BufferOp
    {
        ...
        /// The styles supported are <see cref="Gisoft.GeoAPI.Operations.Buffer.BufferStyle.CapRound" />, <see cref="Gisoft.GeoAPI.Operations.Buffer.BufferStyle.CapButt" />, and <see cref="Gisoft.GeoAPI.Operations.Buffer.BufferStyle.CapSquare" />.
        /// The default is <see cref="Gisoft.GeoAPI.Operations.Buffer.BufferStyle.CapRound" />.
        /// </summary>
        [Obsolete]
