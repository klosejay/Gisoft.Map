...
namespace Gisoft.NetTopologySuite.Operation.Buffer
{
    /// <summary>
    ...
    public class BufferParameters : IBufferParameters
    {
        ...
        /// <remarks>
        /// <para>
        /// The styles supported are <see cref="Gisoft.GeoAPI.Operations.Buffer.EndCapStyle.Round"/>, 
        /// <see cref="Gisoft.GeoAPI.Operations.Buffer.EndCapStyle.Flat"/>, and 
        /// <see cref="Gisoft.GeoAPI.Operations.Buffer.EndCapStyle.Square"/>.
        /// </para>
        /// <para>The default is <see cref="Gisoft.GeoAPI.Operations.Buffer.EndCapStyle.Round"/>.</para>
        /// </remarks>
        ...
        ///</summary>
        /// <remarks>
        /// <para>Allowable values are <see cref="Gisoft.GeoAPI.Operations.Buffer.JoinStyle.Round"/> (which is the default), 
        /// <see cref="Gisoft.GeoAPI.Operations.Buffer.JoinStyle.Mitre"/> and <see cref="Gisoft.GeoAPI.Operations.Buffer.JoinStyle.Bevel"/></para>
        /// </remarks>
        ...
        /// and forced to the equivalent of <see cref="Gisoft.GeoAPI.Operations.Buffer.EndCapStyle.Flat"/>.
        /// </para>
        /// </summary>
