...
namespace Gisoft.NetTopologySuite.Operation.Relate
{
    ...
    /// For instance, <see cref="Gisoft.GeoAPI.Geometries.IntersectionMatrix.IsIntersects"/> is insensitive 
    /// to the choice of <tt>BoundaryNodeRule</tt>, 
    /// whereas <see cref="Gisoft.GeoAPI.Geometries.IntersectionMatrix.IsTouches"/> is affected by the rule chosen.
    /// <para/> 
