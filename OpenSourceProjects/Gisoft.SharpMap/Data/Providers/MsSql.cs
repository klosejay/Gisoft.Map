...
namespace SharpMap.Data.Providers
{
    ...
    public class MsSql : IProvider
    {
        ...
        {
            get { return _factory ?? (_factory = Gisoft.GeoAPI.GeometryServiceProvider.Instance.CreateGeometryFactory(_srid)); }
            set { _factory = value; }
        }
        ...
        {
            //List<Geometries.Geometry> features = new List<Gisoft.GeoAPI.Geometries.IGeometry>();
            using (SqlConnection conn = new SqlConnection(_ConnectionString))
            {
