...
namespace Gisoft.SharpMap.Data.Providers
{
    ...
    /// <code lang="C#">
    /// Gisoft.GeoAPI.Geometries.IGeometryFactory gf = new Gisoft.NetTopologySuite.Geometries.GeometryFactory();
    /// List&#60;Gisoft.GeoAPI.Geometries.IGeometry&#62; geometries = new List&#60;Gisoft.GeoAPI.Geometries.IGeometry&#62;();
    /// //Add two points
    ...
    /// layerVehicles.DataSource = new Gisoft.SharpMap.Data.Providers.GeometryProvider(geometries);
    ...
    public class GeometryProvider : PreparedGeometryProvider
    {
        ...
        /// Initializes a new instance of the <see cref="GeometryProvider"/>
        /// </summary>
        /// <param name="wellKnownBinaryGeometry"><see cref="Gisoft.GeoAPI.Geometries.IGeometry"/> as Well-known Binary to be included in this datasource</param>
        public GeometryProvider(byte[] wellKnownBinaryGeometry)
            : this(GeometryFromWKB.Parse(wellKnownBinaryGeometry, Gisoft.GeoAPI.GeometryServiceProvider.Instance.CreateGeometryFactory()))
        {
        }
        ...
        /// Initializes a new instance of the <see cref="GeometryProvider"/>
        /// </summary>
        /// <param name="wellKnownTextGeometry"><see cref="Gisoft.GeoAPI.Geometries.IGeometry"/> as Well-known Text to be included in this datasource</param>
