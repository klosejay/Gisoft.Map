...
namespace Gisoft.SharpMap.Data.Providers
{
    ...
    public abstract class BaseProvider : EditableProvider, IProvider
    {
        ...
        protected DataSetDescript dataSetDescript;
        public DataSetDescript DataSetDescript { get { if (dataSetDescript == null) { InitMetaData(); } return dataSetDescript; } set => dataSetDescript = value; }
        ...
        public abstract IList<DataSetDescript> GetDataSetDescripts();
        public abstract IList<IBaseProvider> GetProviders();
