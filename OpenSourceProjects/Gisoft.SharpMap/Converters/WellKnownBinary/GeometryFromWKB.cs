...
namespace Gisoft.SharpMap.Converters.WellKnownBinary
{
    /// <summary>
    ///  Converts Well-known Binary representations to a <see cref="Gisoft.GeoAPI.Geometries.IGeometry"/> instance.
    /// </summary>
    /// <remarks>
    /// <para>The Well-known Binary Representation for <see cref="Gisoft.GeoAPI.Geometries.IGeometry"/> (WKBGeometry) provides a portable 
    /// representation of a <see cref="Gisoft.GeoAPI.Geometries.IGeometry"/> value as a contiguous stream of bytes. It permits <see cref="Gisoft.GeoAPI.Geometries.IGeometry"/> 
    /// values to be exchanged between an ODBC client and an SQL database in binary form.</para>
    /// <para>The Well-known Binary Representation for <see cref="Gisoft.GeoAPI.Geometries.IGeometry"/> is obtained by serializing a <see cref="Gisoft.GeoAPI.Geometries.IGeometry"/>
    ...
    {
        /// <summary>
        /// Creates a <see cref="Gisoft.GeoAPI.Geometries.IGeometry"/> from the supplied byte[] containing the Well-known Binary representation.
        /// </summary>
        /// <param name="bytes">byte[] containing the Well-known Binary representation.</param>
        /// <param name="factory">The factory to create the result geometry</param>
        /// <returns>A <see cref="Gisoft.GeoAPI.Geometries.IGeometry"/> bases on the supplied Well-known Binary representation.</returns>
        ...
        /// <summary>
        /// Creates a <see cref="Gisoft.GeoAPI.Geometries.IGeometry"/> based on the Well-known binary representation.
        /// </summary>
        ...
        /// <param name="factory">The factory to create the result geometry</param>
        /// <returns>A <see cref="Gisoft.GeoAPI.Geometries.IGeometry"/> based on the Well-known binary representation.</returns>
