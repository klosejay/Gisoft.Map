...
namespace Gisoft.SharpMap.Converters.WellKnownText
{
    /// <summary>
    ///  Converts a Well-known Text representation to a <see cref="Gisoft.GeoAPI.Geometries.IGeometry"/> instance.
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// Converts a Well-known text representation to a <see cref="Gisoft.GeoAPI.Geometries.IGeometry"/>.
        /// </summary>
        /// <param name="wellKnownText">A <see cref="Gisoft.GeoAPI.Geometries.IGeometry"/> tagged text string ( see the OpenGIS Simple Features Specification.</param>
        /// <returns>Returns a <see cref="Gisoft.GeoAPI.Geometries.IGeometry"/> specified by wellKnownText.  Throws an exception if there is a parsing problem.</returns>
        ...
        /// <returns>Returns a <see cref="Gisoft.GeoAPI.Geometries.IGeometry"/> read from StreamReader. 
