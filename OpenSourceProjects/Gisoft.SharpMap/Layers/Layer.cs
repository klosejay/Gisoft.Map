...
namespace SharpMap.Layers
{
    ...
    public abstract partial class Layer : DisposableObject, ILayer
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="Gisoft.GeoAPI.CoordinateSystems.Transformations.ICoordinateTransformation"/> applied 
        ...
        public virtual ICoordinateTransformation CoordinateTransformation
        {
            ...
            set
            {
                ...
                try
                {
                    ...
                    {
                        _sourceFactory = Gisoft.GeoAPI.GeometryServiceProvider.Instance.CreateGeometryFactory(SRID);
        ...
        /// </summary>
        protected internal IGeometryFactory SourceFactory { get { return _sourceFactory ?? (_sourceFactory = Gisoft.GeoAPI.GeometryServiceProvider.Instance.CreateGeometryFactory(SRID)); } }
        ...
        /// <summary>
        /// Certain Transformations cannot be inverted in ProjNet, in those cases use this property to set the reverse <see cref="Gisoft.GeoAPI.CoordinateSystems.Transformations.ICoordinateTransformation"/> (of CoordinateTransformation) to fetch data from Datasource
        /// 
        ...
        public virtual int SRID
        {
            ...
            set
            {
                if (value != _srid)
                {
                    ...
                    _sourceFactory = Gisoft.GeoAPI.GeometryServiceProvider.Instance.CreateGeometryFactory(value);
        ...
        public virtual int TargetSRID
        {
            ...
            set
            {
                ...
                {
                    _targetSrid = value;
                    _targetFactory = Gisoft.GeoAPI.GeometryServiceProvider.Instance.CreateGeometryFactory(value);
                }
                if (!_shouldNotResetCt)
                    _coordinateTransform = _reverseCoordinateTransform = null;
            }
        ...
        */
        ...
        /// <param name="coordinateTransformation">The <see cref="Gisoft.GeoAPI.CoordinateSystems.Transformations.ICoordinateTransformation"/> to use.</param>
