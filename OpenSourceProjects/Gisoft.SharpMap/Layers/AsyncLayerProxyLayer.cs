...
namespace Gisoft.SharpMap.Layers
{
    ...
    /// </summary>
    /// <example lang="C#">
    /// var map = new Gisoft.SharpMap.Map(new System.Drawing.Size(1024, 786));
    /// var provider = new Gisoft.SharpMap.Data.Providers.Shapefile("&lt;Path to shapefile&gt;", true);
    /// var layer = new Gisoft.SharpMap.Layers.VectorLayer("LAYER1", provider);
