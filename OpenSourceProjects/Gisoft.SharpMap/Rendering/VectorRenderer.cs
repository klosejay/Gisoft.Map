...
namespace SharpMap.Rendering
{
    ...
    public static class VectorRenderer
    {
        ...
        /// <param name="map">Map reference</param>
        [MethodImpl(MethodImplOptions.Synchronized)]
        public static void DrawMultiPolygon(Graphics g, IMultiPolygon pols, Brush brush, Pen pen, bool clip, MapViewport map)
        {
        ...
        /// <summary>
        /// Renders a <see cref="Gisoft.GeoAPI.Geometries.IMultiPoint"/> to the map.
        /// </summary>
        /// <param name="g">Graphics reference</param>
