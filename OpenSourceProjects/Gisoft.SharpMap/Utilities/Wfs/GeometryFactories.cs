...
namespace Gisoft.SharpMap.Utilities.Wfs
{
    ...
    internal abstract class GeometryFactory : IDisposable
    {
        ...
        /// derived from <see cref="Gisoft.GeoAPI.Geometries.IGeometry"/>.
        /// </summary>
    ...
    /// <summary>
    /// This class produces instances of type <see cref="Gisoft.GeoAPI.Geometries.IPoint"/>.
    ...
    internal class PointFactory : GeometryFactory
    {
        ...
        /// <summary>
        /// This method produces instances of type <see cref="Gisoft.GeoAPI.Geometries.IPoint"/>.
        /// </summary>
        /// <returns>The created geometries</returns>
    ...
    /// <summary>
    /// This class produces instances of type <see cref="Gisoft.GeoAPI.Geometries.ILineString"/>.
    /// The base class is <see cref="GeometryFactory"/>.
    /// </summary>
    internal class LineStringFactory : GeometryFactory
    {
        ...
        /// <summary>
        /// This method produces instances of type <see cref="Gisoft.GeoAPI.Geometries.ILineString"/>.
        /// </summary>
        /// <returns>The created geometries</returns>
        internal override Collection<IGeometry> createGeometries()
        {
    ...
    /// <summary>
    /// This class produces instances of type <see cref="Gisoft.GeoAPI.Geometries.IPolygon"/>.
    /// The base class is <see cref="GeometryFactory"/>.
    /// </summary>
    ...
    /// <summary>
    /// This class produces instances of type <see cref="Gisoft.GeoAPI.Geometries.IMultiPoint"/>.
    /// The base class is <see cref="GeometryFactory"/>.
    /// </summary>
    internal class MultiPointFactory : GeometryFactory
    {
        ...
        /// <summary>
        /// This method produces instances of type <see cref="Gisoft.GeoAPI.Geometries.IMultiPoint"/>.
        /// </summary>
        /// <returns>The created geometries</returns>
        internal override Collection<IGeometry> createGeometries()
        {
    ...
    /// <summary>
    /// This class produces objects of type <see cref="Gisoft.GeoAPI.Geometries.IMultiLineString"/>.
    /// The base class is <see cref="GeometryFactory"/>.
    /// </summary>
    ...
    /// <summary>
    /// This class produces instances of type <see cref="Gisoft.GeoAPI.Geometries.IMultiPolygon"/>.
    /// The base class is <see cref="GeometryFactory"/>.
    /// </summary>
