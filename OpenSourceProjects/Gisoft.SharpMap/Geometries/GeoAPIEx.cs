...
namespace Gisoft.GeoAPI.Geometries
{
    ...
    public static class GeoAPIEx
    {
        ...
        {
            return Gisoft.NetTopologySuite.Algorithm.Orientation.IsCCW(self.Coordinates);
        }
        ...
        {
            var factory = self == null ? new Gisoft.NetTopologySuite.Geometries.GeometryFactory() : self.Factory;
            var reader = new Gisoft.NetTopologySuite.IO.WKTReader(factory);
