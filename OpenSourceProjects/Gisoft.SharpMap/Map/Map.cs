...
namespace Gisoft.SharpMap
{
    ...
    public class Map : IDisposable
    {
        ...
        /// <summary>
        /// Static constructor. Needed to get <see cref="Gisoft.GeoAPI.GeometryServiceProvider.Instance"/> set.
        /// </summary>
        static Map()
        {
            try
            {
                _logger.Debug("Trying to get Gisoft.GeoAPI.GeometryServiceProvider.Instance");
                var instance = Gisoft.GeoAPI.GeometryServiceProvider.Instance;
                if (instance == null)
                {
            ...
            {
                _logger.Debug("Loading Gisoft.NetTopologySuite");
                Assembly.Load("Gisoft.NetTopologySuite");
                _logger.Debug("Loaded Gisoft.NetTopologySuite");
                _logger.Debug("Trying to get Gisoft.GeoAPI.GeometryServiceProvider.Instance");
                var instance = Gisoft.GeoAPI.GeometryServiceProvider.Instance;
                if (instance == null)
                {
            ...
            if (System.ComponentModel.LicenseManager.UsageMode != System.ComponentModel.LicenseUsageMode.Designtime)
            {
                ...
                // We have to do this initialization with reflection due to the fact that NTS can reference an older version of Gisoft.GeoAPI and redirection 
                // is not available at design time..
                var ntsAssembly = Assembly.Load("Gisoft.NetTopologySuite");
                _logger.Debug("Loaded Gisoft.NetTopologySuite");
                Trace.WriteLine("Loaded Gisoft.NetTopologySuite");
                try
                {
                    _logger.Debug("Trying to access Gisoft.GeoAPI.GeometryServiceProvider.Instance");
                    Trace.WriteLine("Trying to access Gisoft.GeoAPI.GeometryServiceProvider.Instance");
                    if (Gisoft.GeoAPI.GeometryServiceProvider.Instance == null)
                    {
                        _logger.Debug("Returned null, setting it to default");
                        Trace.WriteLine("Returned null, setting it to default");
                        var ntsApiGeometryServices = ntsAssembly.GetType("Gisoft.NetTopologySuite.NtsGeometryServices");
                        Gisoft.GeoAPI.GeometryServiceProvider.Instance =
                            ntsApiGeometryServices.GetProperty("Instance").GetValue(null, null) as
                                Gisoft.GeoAPI.IGeometryServices;
                    }
                }
        ...
        public Map(Size size)
        {
            ...
            {
                Factory = Gisoft.GeoAPI.GeometryServiceProvider.Instance.CreateGeometryFactory(_srid);
            }
