...
namespace Gisoft.SharpMap.Forms
{
    ...
    public partial class MapToolStrip : System.Windows.Forms.ToolStrip
    {
        ...
        private void OnMapCenterChanged(Gisoft.GeoAPI.Geometries.Coordinate geoPoint)
        {
        }
        ...
        {
            var queryableLayers = new Dictionary<int, Gisoft.SharpMap.Layers.ILayer>();
            var i = 0;
            foreach (var layer in _mapBox.Map.Layers)
            {
                if (layer is Gisoft.SharpMap.Layers.ICanQueryLayer)
