...
namespace Gisoft.SharpMap.Forms.ToolBar
{
    ...
    public class MapQueryToolStrip : MapToolStrip
    {
        ...
        public void InitializeComponent()
        {
            ...
            // _clear
            // 
            this._clear.Image = global::Gisoft.SharpMap.Properties.Resources.layer_delete;
            ...
            this._queryWindow.Image = global::Gisoft.SharpMap.Properties.Resources.rectangle_edit;
            ...
            this._queryGeometry.Image = global::Gisoft.SharpMap.Properties.Resources.query_spatial_vector;
        ...
        private void OnListChanged(object sender, System.ComponentModel.ListChangedEventArgs e)
        {
            ...
            foreach(var lyr in MapControl.Map.Layers)
            {
                ...
                if (lyr is Gisoft.SharpMap.Layers.ICanQueryLayer)
                {
        ...
        private void OnMapQueried(Gisoft.SharpMap.Data.FeatureDataTable features)
        {
            OnClear(this, EventArgs.Empty);

            if (MapControl == null) return;

            _geometryProvider = new Gisoft.SharpMap.Data.Providers.GeometryFeatureProvider(features);
            _layer = new Gisoft.SharpMap.Layers.VectorLayer("QueriedFeatures", _geometryProvider);
