...
using Gisoft.SharpMap.Properties;
    ...
    public partial class MapZoomToolStrip : MapToolStrip
    {
        ...
        private void OnCheckedChanged(object sender, EventArgs e)
        {
            ...
            if (tsb == _lock)
            {
                ...
                {
                    mvpLock.Lock();
                    tsb.Image = global::Gisoft.SharpMap.Properties.Resources.locked;
                }
                else
                {
                    mvpLock.Unlock();
                    tsb.Image = global::Gisoft.SharpMap.Properties.Resources.unlocked;
                }
