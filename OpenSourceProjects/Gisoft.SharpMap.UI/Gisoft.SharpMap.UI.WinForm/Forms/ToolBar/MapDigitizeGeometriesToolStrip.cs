...
namespace Gisoft.SharpMap.Forms.ToolBar
{
    ...
    public class MapDigitizeGeometriesToolStrip : MapToolStrip
    {
        ...
        */
        ...
        private Gisoft.SharpMap.Data.Providers.GeometryProvider _geometryProvider;
        private Gisoft.SharpMap.Layers.VectorLayer _layer;
        ...
        protected override void OnMapControlChangedInternal(EventArgs e)
        {
            ...
            _geometryProvider = new Gisoft.SharpMap.Data.Providers.GeometryProvider((Gisoft.GeoAPI.Geometries.IGeometry)null);
            _layer = new Gisoft.SharpMap.Layers.VectorLayer("_tmp_Geometries", _geometryProvider);
        ...
        public Gisoft.SharpMap.Forms.MapBox.GeometryDefinedHandler GeometryDefinedHandler{ get; set; }
