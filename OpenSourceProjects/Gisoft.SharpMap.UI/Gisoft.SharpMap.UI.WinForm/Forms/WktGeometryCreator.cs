...
namespace Gisoft.SharpMap.Forms
{
    public partial class WktGeometryCreator : Form
    {
        ...
        private Gisoft.GeoAPI.Geometries.IGeometry _geometry;
        public Gisoft.GeoAPI.Geometries.IGeometry Geometry
        {
            get
            {
                return _geometry;
        ...
        private readonly NetTopologySuite.IO.WKTReader _wktReader = new NetTopologySuite.IO.WKTReader(
            Gisoft.GeoAPI.GeometryServiceProvider.Instance.CreateGeometryFactory());
