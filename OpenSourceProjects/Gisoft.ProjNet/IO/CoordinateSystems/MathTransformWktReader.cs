...
using Gisoft.ProjNet.CoordinateSystems;
using Gisoft.ProjNet.CoordinateSystems.Transformations;

namespace Gisoft.ProjNet.Converters.WellKnownText
{
    /// <summary>
    ...
    public static class MathTransformWktReader
    {
        ...
        {
            List<Gisoft.GeoAPI.CoordinateSystems.Parameter> paramList = new List<Gisoft.GeoAPI.CoordinateSystems.Parameter> ();
            while (tokenizer.GetStringValue () == "PARAMETER")
            {
                ...
                if (tokenizer.GetStringValue () != "]")
                    tokenizer.NextToken ();
                paramList.Add (new Gisoft.GeoAPI.CoordinateSystems.Parameter (paramName, paramValue));
            }
