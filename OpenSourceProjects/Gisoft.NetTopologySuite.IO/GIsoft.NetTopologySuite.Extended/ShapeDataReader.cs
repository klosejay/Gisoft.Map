...
using Gisoft.NetTopologySuite.Index;
using Gisoft.NetTopologySuite.Index.Strtree;
using Gisoft.NetTopologySuite.IO.Handlers;
using Gisoft.NetTopologySuite.IO.ShapeFile.Extended.Entities;
using Gisoft.NetTopologySuite.IO.Streams;

namespace Gisoft.NetTopologySuite.IO.ShapeFile.Extended
{
