...
namespace Gisoft.GeoAPI.Operation.Buffer
{
    /// <summary>
    ...
    public interface IBufferParameters
    {
        ...
        /// <remarks>
        /// <para>
        /// The styles supported are <see cref="Gisoft.GeoAPI.Operation.Buffer.EndCapStyle.Round"/>, <see cref="Gisoft.GeoAPI.Operation.Buffer.EndCapStyle.Flat"/>, and <see cref="Gisoft.GeoAPI.Operation.Buffer.EndCapStyle.Square"/>.
        /// </para>
        /// <para>The default is <see cref="Gisoft.GeoAPI.Operation.Buffer.EndCapStyle.Round"/>.</para>
        /// </remarks>
        ...
        ///</summary>
        /// <remarks>
        /// <para>Allowable values are <see cref="Gisoft.GeoAPI.Operation.Buffer.JoinStyle.Round"/> (which is the default), <see cref="Gisoft.GeoAPI.Operation.Buffer.JoinStyle.Mitre"/> and <see cref="Gisoft.GeoAPI.Operation.Buffer.JoinStyle.Bevel"/></para>
        /// </remarks>
        ...
        /// and forced to the equivalent of <see cref="Gisoft.GeoAPI.Operation.Buffer.EndCapStyle.Flat"/>.
        /// </para>
        /// </summary>
