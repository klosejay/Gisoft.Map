...
namespace Gisoft.GeoAPI.Geometries
{
        ...
        IComparable, IComparable<IEnvelope>
    {
        ...
        /// <summary>
        /// Method to initialize the envelope with a <see cref="T:Gisoft.GeoAPI.Geometries.ICoordinate"/>. Calling this function will result in an envelope having no extent but a location.
        /// </summary>
        /// <param name="p">The point</param>
        ...
        /// <summary>
        /// Method to initialize the envelope with two <see cref="T:Gisoft.GeoAPI.Geometries.ICoordinate"/>s.
        /// </summary>
