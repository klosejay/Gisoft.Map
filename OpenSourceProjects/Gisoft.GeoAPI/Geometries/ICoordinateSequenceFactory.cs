...
namespace Gisoft.GeoAPI.Geometries
{
    ...
    public interface ICoordinateSequenceFactory
    {
        ...
        /// The ordinates each coordinate has. <see cref="Gisoft.GeoAPI.Geometries.Ordinates.XY"/> is fix, <see cref="Gisoft.GeoAPI.Geometries.Ordinates.Z"/> and <see cref="Gisoft.GeoAPI.Geometries.Ordinates.M"/> can be set.
        /// </param>
        /// <returns>A coordinate sequence.</returns>
