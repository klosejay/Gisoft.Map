...
namespace Gisoft.GeoAPI.Geometries
{
    ...
    /// Mutation should be performed by creating a new Geometry object (see <see cref="T:Gisoft.NetTopologySuite.Geometries.Utilities.GeometryEditor"/> 
    /// and <see cref="T:Gisoft.NetTopologySuite.Geometries.Utilities.GeometryTransformer"/> for convenient ways to do this).
    ...
    /// <seealso cref="T:Gisoft.NetTopologySuite.Geometries.Utilities.GeometryTransformer"/> 
    /// <see cref="T:Gisoft.NetTopologySuite.Geometries.Utilities.GeometryEditor"/> 
